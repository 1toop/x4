...
**Note**: If you have many features enabled in your script ur using for autofarm, boost may expire often because script is busy with other tasks (tested with atlas)
...
maintains x4 field boost using One Loaded Dice, Glitter, Field Dice.

## setup

1. add items to hotbar (any slots)
2. set field: `_G.field = "Pepper Patch"`
3. run script
